...
console.log(printName("Emmanuel"));
...
const greeting = paramStr => {
  console.log(`Hello, ${paramStr}`)
} 
greeting("Kayla")
...
*/
const add = (arg1, arg2) =>{
  let theArgument1 = Number(arg1)
  let theArgument2 = Number(arg2)
  return (theArgument1 + theArgument2)
}
...
console.log(bestMovie("Palm Springs"))
...
let capSampleString = sampleString.toUpperCase();
console.log(capSampleString);
...
console.log(emailCheck(`yaimodel@hotmail.com`));
...
const chocoFroggies = (goldAmt) =>{
  let frogsAmt = goldAmt / 3;
  return frogsAmt
}

const totalChocoFrogs = chocoFroggies(27)
console.log(totalChocoFrogs)
...
const chocoFroggies2 = (goldAmt2) =>{
  let frogsAmt = Math.floor(goldAmt2 / 3);
  return frogsAmt
}
const totalChocoFrogs2 = chocoFroggies2(17);
console.log(totalChocoFrogs2)
...
let correctOrder = ascendingOrder(sampleArray)
